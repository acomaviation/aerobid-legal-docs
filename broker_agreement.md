...
1. #### **Interpretation**
   1. The definitions and rules of interpretation in this clause apply in these Terms.
      ...
      - **Bid:**
        - an Operator’s bid to service a Charter Request submitted to the Platform by the Broker.
      - **Broker:**
      ...
      - **Operator:**
        - an aircraft operator who has subscribed to the Platform for the purpose of submitting Bids on Charter Requests.
      - **Platform:**
      ...
      - **Purpose:**
        - submitting Charter Requests and being introduced to Operators who may be able to service such Charter Requests.
      - **Software:**
        - the underlying hardware and software required for the Platform to operate.
      - **Subscription Fees:**
        - the subscription fees payable by the Broker to ACOM for the User Subscriptions as per the fee schedule published on the billing page of the Platform and updated in accordance with clause 11.5.
      - **Subscription Term:**
